        ...
        <div class="px-2 py-2  p-3 rounded position-relative" id="modal">
            <div class="btn   position-absolute top-0 end-0" id="cerrar_modal">
                ...
                <div class="row">
                        ...
                        <div class="row col-md-5 col-12 overflow-auto">
                            <div class="col-12" id="texto-modal"></div>
                            <div class="col-12 align-self-end text-end fst-italic" id="fecha-modal"> fecha </div>
                        </div>
                    </div>
            </div>
        </div>
